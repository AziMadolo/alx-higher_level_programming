...
/**
 * print_python_bytes_info - Prints basic information about Python byte objects.
...
/**
 * print_python_float_info - Prints basic information about Python float objects.
